...
export const routes: Routes = [
    ...
    // Authenticated Routes (requires login)
    {
        ...
        children: [
            ...
            { path: 'team/:id/chat/private/:memberId', component: TeamChatComponent, canActivate: [teamChatGuard] },
            { path: 'team/:id/private-chat/:memberId', component: TeamChatComponent, canActivate: [teamChatGuard] },
            { path: 'team/:id/chat', component: TeamChatComponent, canActivate: [teamChatGuard] },
            { path: 'team/:id/community', loadComponent: () => import('./pages/communities.component').then(m => m.CommunitiesComponent) },
