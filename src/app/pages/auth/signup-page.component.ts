      ...
      <div class="w-full max-w-md bg-card border border-border rounded-2xl shadow-xl overflow-hidden relative">
        ...
        <div class="p-8">
          <div class="text-center mb-8">
            <h1 class="text-2xl font-bold mb-2">Join the League ✨</h1>
            <p class="text-muted-foreground text-sm">Create your account in seconds</p>
          </div>
          ...
          <div class="bg-primary/10 border border-primary/20 rounded-xl p-4 mb-6 flex items-start gap-3">
            ...
            <p class="text-sm text-primary/90">
              Already have an account? <a routerLink="/auth/login" class="font-bold underline hover:text-primary transition-colors">Login</a>
            </p>
          </div>
          ...
          <form (ngSubmit)="onSubmit()" #signupForm="ngForm" class="space-y-4">
            ...
            <div class="space-y-1.5">
              <label class="text-sm font-medium text-foreground ml-1">Full name</label>
            ...
            <div class="space-y-1.5">
              ...
              <p class="text-xs text-muted-foreground ml-1 mt-1">Minimum 8 characters recommended</p>
            </div>
            ...
            <p class="text-center text-xs text-muted-foreground mt-4">
              By signing up, you agree to our <a href="#" class="underline hover:text-foreground">Terms of Service</a>
            </p>
          </form>
  ...
  onSubmit() {
    ...
    this.authService.register(payload).subscribe({
      ...
      error: (err: any) => {
        ...
        this.error = msg || "Error during account creation. Check that the email is not already in use.";
      }
    });
  }
}
