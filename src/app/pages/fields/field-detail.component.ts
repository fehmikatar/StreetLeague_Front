        ...
        <div class="grid lg:grid-cols-3 gap-8">
          <div class="lg:col-span-2">
            ...
            <div class="bg-card rounded-2xl p-6 border border-border">
              <h2 class="mb-2">Central Park Football Field</h2>
              <div class="flex items-center gap-2 text-muted-foreground mb-4"><lucide-icon [img]="MapPinIcon" class="w-4 h-4"></lucide-icon><span>Paris 15th</span></div>
              <div class="flex items-center gap-4 mb-6">
                <div class="flex items-center gap-1"><lucide-icon [img]="StarIcon" class="w-5 h-5 text-primary"></lucide-icon><span class="font-bold">4.8</span><span class="text-muted-foreground">(124 reviews)</span></div>
                <div class="flex items-center gap-1"><lucide-icon [img]="CheckCircleIcon" class="w-5 h-5 text-primary"></lucide-icon><span class="text-primary font-semibold">Available</span></div>
              </div>
              <p class="text-muted-foreground mb-6">A professional synthetic grass football field, ideal for 11 or 7-a-side matches. Equipped with changing rooms, showers and LED lighting.</p>
              <div class="grid grid-cols-2 gap-4">
                <div class="flex items-center gap-2 text-sm"><lucide-icon [img]="ClockIcon" class="w-4 h-4 text-primary"></lucide-icon><span>7 AM - 11 PM</span></div>
                <div class="flex items-center gap-2 text-sm"><lucide-icon [img]="UsersIcon" class="w-4 h-4 text-primary"></lucide-icon><span>Up to 22 players</span></div>
              </div>
            </div>
          </div>
          <div class="space-y-6">
            <div class="bg-card rounded-2xl p-6 border border-border sticky top-6">
              <div class="text-3xl font-bold text-primary mb-1">50$<span class="text-base font-normal text-muted-foreground">/hour</span></div>
              <div class="space-y-4 mt-4">
                ...
                <div>
                  <label class="block mb-2 text-sm font-semibold">Time Slot</label>
