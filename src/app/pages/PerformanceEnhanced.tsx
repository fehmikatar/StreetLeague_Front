      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20 text-primary">
            ...
            <p>Chargement des données depuis le Backend...</p>
          </div>
        ) : (
          <>
            {/* PLAYER VIEW */}
              ...
              <>
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    <StatsWidget label="Buts Marqués" value={playerStats.goals} icon={Target} color="#F26419" automated={true} />
                    <StatsWidget label="Passes Décisives" value={playerStats.assists} icon={Zap} color="#06D6A0" automated={true} />
                    <StatsWidget label="Matchs Joués" value={playerStats.matchesPlayed} icon={Activity} color="#1DB954" automated={true} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="lg:col-span-2 space-y-8">
                    ...
                    {/* Ranking Section */}
                    <div>
                      <h2 className="text-xl font-bold mb-4">Classement Général</h2>
                ...
                <div className="bg-card rounded-2xl p-6 border border-border">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center p-4 bg-primary/5 rounded-xl">
                      ...
                      <div className="text-sm text-muted-foreground">Matchs Cumulés</div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="p-4 bg-primary/5 border border-primary/20 rounded-xl">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="text-sm">
                          <p className="font-semibold text-primary mb-1">Activité de l'équipe</p>
